...
Public Class SignInTeachers
    ...
    Private Sub Guna2Button1_Click_1(sender As Object, e As EventArgs) Handles Guna2Button1.Click
        ...
        Dim command As New MySqlCommand("SELECT `Teachers_Username`, `Teachers_Password` FROM `faculty` WHERE `Teachers_Username` = @usn AND `Teachers_Password` = @pass", conn.getConnection())
        ...
        If IDno.Text.Trim() = "" Or IDno.Text.Trim().ToLower() = "ID" Then
            ...
            MessageBox.Show("Enter Your ID To Login", "Missing ID", MessageBoxButtons.OK, MessageBoxIcon.Error)
        ...
        Else
            ...
            If table.Rows.Count > 0 Then
                ...
                Me.Hide()
                Dim mainAppForm As New TeacherDashboard()
                mainAppForm.Show()
                IDno.Text = ""
                StuPass.Text = ""
            Else
